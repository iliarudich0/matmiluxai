  ...
  items: [
    {
      ...
      a: {
        pl: 'MiLux AI Labs tworzy praktyczne aplikacje AI dla edukacji, zdrowia, bezpieczeństwa i produktywności. Nasze projekty obejmują m.in. Tik‑Mathik AI, TikDrive, TikEveryLang AI, TikLawyer AI, TikCorporate AI, SafeZoneX, CarFix AI, HealthSymptom AI, ExplainLikeAI, InterviewCoach AI, MemoryBoost AI, ContractScan AI, StudyPlanner AI, TikPlant AI, TikFinance AI, TikSpaceZ AI, TikDietX AI oraz TipExam AI. Skupiamy się na realnych efektach i użyteczności.',
        en: 'MiLux AI Labs builds practical AI apps for education, health, safety, and productivity. Our projects include Tik‑Mathik AI, TikDrive, TikEveryLang AI, TikLawyer AI, TikCorporate AI, SafeZoneX, CarFix AI, HealthSymptom AI, ExplainLikeAI, InterviewCoach AI, MemoryBoost AI, ContractScan AI, StudyPlanner AI, TikPlant AI, TikFinance AI, TikSpaceZ AI, TikDietX AI, and TipExam AI. We focus on real outcomes and usability.',
        ru: 'MiLux AI Labs создаёт практичные AI‑приложения для образования, здоровья, безопасности и продуктивности. Среди проектов: Tik‑Mathik AI, TikDrive, TikEveryLang AI, TikLawyer AI, TikCorporate AI, SafeZoneX, CarFix AI, HealthSymptom AI, ExplainLikeAI, InterviewCoach AI, MemoryBoost AI, ContractScan AI, StudyPlanner AI, TikPlant AI, TikFinance AI, TikSpaceZ AI, TikDietX AI и TipExam AI. Мы фокусируемся на реальной пользе и удобстве.'
      }
    },
    {
      q: {
